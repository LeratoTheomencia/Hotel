  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{flexDirection: 'row'}}>
        <Text style={{marginTop: 10, fontWeight: '600', marginLeft: 3}}>Bedroom</Text>
            <TouchableOpacity>
            <Text style={styles.title} onPress={() => navigation.navigate('SuiteDetails')}>Details</Text>
        </TouchableOpacity>
      </View>
        <Image source={require('../../assets/Images/suite.jpg')} style={styles.img1} />
     

        <Image source={require('../../assets/Images/pexels-photo-suite1.jpeg')} style={styles.img2} /> 

        <Image source={require('../../assets/Images/pexels-photo-suit3.jpeg')} style={styles.img3} />
      ...
      <View style={{flexDirection:'row', marginTop: -5}}>
             <Text style={{marginLeft: 20, marginBottom: -1}}>BBQ facility</Text>

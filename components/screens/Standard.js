    ...
    <View style={styles.container}>
      ...
      <Text style={styles.header}>Standard</Text>
        ...
        <Text style={{marginTop: 10, fontWeight: '600', marginLeft: 3}}>Bedroom</Text>
         <TouchableOpacity>
            <Text style={styles.title} onPress={() => navigation.navigate('StandardDetails')}>Details</Text>
        </TouchableOpacity>
       </View>
        <Image source={require('../../assets/Images/standard 1.jpg')} style={styles.img1} />
        

        <Image source={require('../../assets/Images/bedroom.jpeg')} style={styles.img2} /> 
       

        <Image source={require('../../assets/Images/standard bedroom.jpeg')} style={styles.img3} />
